...
const Sidebar = () => {
    ...
    const adminMenuItems = [
        ...
        { name: "Salary Rates", path: "/admin-dashboard/salary-rates", icon: "fas fa-cogs", end: false },
        ...
        { name: "Live Chat", path: "/admin-dashboard/live-chat", icon: "fas fa-comments", end: false },
