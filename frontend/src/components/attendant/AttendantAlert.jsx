...
const AttendantAlert = () => {
  ...
  const fetchSettings = async () => {
    setLoading(true);
    try {
      const response = await axios.get("http://localhost:3000/api/attendant-telegram-settings", {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:3000/api/attendant-telegram-settings`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("pos-token")}`,
  ...
  const handleTestNotification = async () => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:3000/api/attendant-telegram-settings/test`,
        {},
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("pos-token")}`,
  ...
  return (
    <main>
      <div className="container-fluid px-4">
        <h1 className="mt-4">My Telegram Checkout Alerts</h1>
        <ol className="breadcrumb mb-4">
          <li className="breadcrumb-item">Dashboard</li>
          <li className="breadcrumb-item active">Telegram Alerts</li>
        </ol>

        {/* Info Alert */}
        <div className="alert alert-info alert-dismissible fade show mb-4" role="alert">
          <i className="fas fa-info-circle me-2"></i>
          <strong>Attendant Alert System:</strong> Set up your personal Telegram bot to receive instant notifications when guests check out. Each attendant can configure their own bot.
        </div>
          ...
          <div className="col-lg-6 mb-4">
            <div className="card shadow-sm">
              <div className="card-header bg-white py-3">
                ...
                <span className="fw-semibold">Configure Your Personal Telegram Bot</span>
              </div>
              ...
              <div className="card-footer bg-light">
                <small className="text-muted">
                  ...
                  You will receive alerts only when guests check out from rooms.
                </small>
              </div>
            </div>
            ...
            <div className="card shadow-sm mt-4">
              <div className="card-header bg-white py-3">
                ...
                <span className="fw-semibold">What You'll Receive</span>
              </div>
              <div className="card-body">
                <div className="alert alert-light border mb-0">
                  <strong>🧹 ROOM CLEANING REQUIRED</strong><br/><br/>
                  <strong>Room(s):</strong> 101, 102, 103<br/><br/>
                  The room(s) are now dirty and need to be cleaned.<br/>
                  Please clean as soon as possible.<br/><br/>
                  <em>Alert sent at 1/5/2025, 10:30:45 AM</em>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card shadow-sm">
              ...
              <div className="card-body p-4">
                <div className="instruction-section">
                  ...
                  <div className="instruction-step mb-3">
                    <div className="d-flex align-items-start">
                      ...
                      <div>
                        ...
                        <p className="mb-0 text-muted">BotFather will ask for a name (e.g., "My Checkout Alert Bot").</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="instruction-step mb-3">
                    <div className="d-flex align-items-start">
                      ...
                      <div>
                        ...
                        <p className="mb-0 text-muted">Choose a username ending in "bot" (e.g., "myname_checkout_bot").</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="instruction-step mb-3">
                    <div className="d-flex align-items-start">
                      <span className="badge bg-success rounded-circle me-3" style={{width: '30px', height: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>8</span>
                      <div>
                        <strong>Save Settings Here</strong>
                        <p className="mb-0 text-muted">Enter your Bot Token and Chat ID in the form, then click "Save Settings".</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="instruction-step mb-3">
                    <div className="d-flex align-items-start">
                      <span className="badge bg-info text-white rounded-circle me-3" style={{width: '30px', height: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>9</span>
                      <div>
                        <strong>Test Your Bot</strong>
                        <p className="mb-0 text-muted">Click "Send Test" button to verify everything works!</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="alert alert-warning mt-4 mb-0">
                    ...
                    <ul className="mb-0">
                      ...
                      <li>This is your personal alert bot</li>
                      <li>If compromised, regenerate token via BotFather</li>
                      <li>Only you will receive alerts from your bot</li>
                    </ul>
                  </div>
                </div>
              </div>
