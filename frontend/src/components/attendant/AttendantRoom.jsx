...
const AttendantRooms = () => {
  ...
  const handleUpdateStatus = async (e) => {
    ...
    try {
      ...
      const attendantId = user?._id || user?.id;
      ...
      console.log("Extracted attendant ID:", attendantId);
      console.log("Cleaning status:", cleaningStatus);
      console.log("=== END DEBUG ===");
      
      const response = await axios.put(
        `http://localhost:3000/api/room-instances/${selectedRoom._id}/cleaning`,
        {
      ...
      setError(err.response?.data?.message || "Error updating room status");
      setTimeout(() => setError(null), 5000);
    }
  };
  ...
  return (
    <main>
      <div className="container-fluid px-4">
        <h1 className="mt-4">Room Cleaning Management</h1>
              ...
              <div className="modal-content">
                <div className="modal-header bg-primary text-white">
                  <h5 className="modal-title fw-semibold">
                    Update Room Status - {selectedRoom.room_number}
                  </h5>
                  <button 
                    type="button" 
                ...
                <div className="modal-body">
                  ...
                  <div className="mb-3">
                    <label htmlFor="cleaningStatus" className="form-label fw-medium">
                      Cleaning Status <span className="text-danger">*</span>
                    </label>
                    <select 
                  ...
                  {selectedRoom.last_cleaned_at && (
                    <div className="alert alert-info mb-0">
                      <small>
                        <strong>Last Cleaned:</strong> {new Date(selectedRoom.last_cleaned_at).toLocaleString()}
                        {selectedRoom.last_cleaned_by && (
                          <> by <strong>{selectedRoom.last_cleaned_by.name || selectedRoom.last_cleaned_by.username || selectedRoom.last_cleaned_by.email}</strong></>
                        )}
                      </small>
                    </div>
                  )}
